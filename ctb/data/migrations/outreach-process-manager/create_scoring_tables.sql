...
CREATE TABLE IF NOT EXISTS marketing.ple_lead_scoring (person_unique_id TEXT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS marketing.bit_signal_weights (signal_name TEXT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS marketing.scoring_model_versions (id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS marketing.scoring_history (id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS marketing.bit_signal_events (id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS marketing.attribution_feedback (id SERIAL PRIMARY KEY,
    person_unique_id TEXT NOT NULL,
    company_unique_id TEXT NOT NULL,
