...
# ─────────────────────────────────────────────
# CTB Branch: meta/global-config
# Barton ID: 08.01.01
# Unique ID: CTB-9A3736F9
# Blueprint Hash:
...
cp "$SOURCE_REPO/global-config/scripts/ctb_init.sh" "global-config/scripts/ctb_init.sh"
cp "$SOURCE_REPO/global-config/scripts/ctb_verify.sh" "global-config/scripts/ctb_verify.sh"
...
This repository now follows Barton Enterprises CTB Doctrine.
...
log_info "4. Run health check: bash global-config/scripts/ctb_verify.sh"
log_info ""
log_info "🌲 Welcome to the Barton Enterprises CTB ecosystem!"
