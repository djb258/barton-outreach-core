...
CREATE TABLE IF NOT EXISTS marketing.campaigns (id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS marketing.campaign_audit_log (id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS marketing.campaign_executions (id SERIAL PRIMARY KEY,
    campaign_id TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS marketing.campaign_templates (id SERIAL PRIMARY KEY,
...
BEGIN
    ...
    -- Generate Barton ID: 04.04.03.[type_code].[sequence].[checksum]
